                ...
                child: Row(
                  children: <Widget>[
                    Stack(
                      ...
                      children: <Widget>[
                        Container(child:Image.asset('resize.png'),height: 100,width: 200,),
                        Container(
              ...
              Column(
                ...
                children: [
                  Container(
                    ...
                    child: Text('Deposit Money',textAlign: TextAlign.start ,style: TextStyle(color: Colors.white,fontSize: 25.0 , fontWeight: FontWeight.bold),),),
                  ...
                  Container(
                    ...
                    ElevatedButton(onPressed: () {},
                        child: Text('Deposit Now', style: TextStyle(
