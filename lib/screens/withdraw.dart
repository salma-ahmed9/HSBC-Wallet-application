                ...
                child: Row(
                  children: <Widget>[
                    Stack(
                      ...
                      children: <Widget>[
                        Container(child:Image.asset('hesbes.png'),),
                        Container(
                            margin: EdgeInsets.only(top:115, left: 12),
                            child: Text('E-Wallet',style: TextStyle(fontSize: 50 ,fontWeight: FontWeight.w400),)
                        ),
              ...
              Column(
                ...
                children: [
                  Container(
                    ...
                    child: Text('Withdraw Money',textAlign: TextAlign.start ,style: TextStyle(color: Colors.white,fontSize: 25.0 , fontWeight: FontWeight.bold),),),
                  ...
                  Container(
                    ...
                    ElevatedButton(onPressed: () {},
                        child: Text('Withdraw Now', style: TextStyle(
